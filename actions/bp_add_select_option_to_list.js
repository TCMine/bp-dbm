module.exports = {
  ...
  subtitle(data, presets) {
    ...
    return `Add option "${data.sname}" to ${storage[parseInt(data.storage, 10)]} (${data.varName})`;
  },
  ...
  fields: ["storage", "varName", "addType", "position", "sname", "icon", "value"],
...
<br><br><br>
<div style="w-full; height: 1px; background-color: gray; margin: 10px;"></div>


<div style="padding-top: 8px;">
	<span class="dbminputlabel">Icon ‒ <a onclick="window.openGlobalLink('https://react-icons.github.io/react-icons/icons/fa6/')" class="ui">Predefined Icons <i class="icon external"></i></a></span><br>
...
<div style="padding-top: 16px;">
	...
	<input id="sname" class="round" type="text" name="is-eval">
</div>
<div style="padding-top: 16px;">
  ...
  action(cache) {
    ...
    let val = {
      icon: this.evalMessage(data.icon, cache).replace("fa6 ", ""),
      name: this.evalMessage(data.sname, cache),
      value: this.evalMessage(data.value, cache),
    };
